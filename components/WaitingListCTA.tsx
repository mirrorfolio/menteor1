...
export default function WaitingListCTA() {
  return (
    <section className="w-full flex justify-center py-10">
      <Card className="flex flex-col gap-4 text-center px-4 w-full transition-all duration-700 ease-in-out bg-[#E5F4F2] py-8 backdrop-blur-sm rounded-lg  max-w-7xl mx-auto  hover:shadow-md">
